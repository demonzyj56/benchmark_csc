...
def parse_args():
    ...
    parser.add_argument('--train_dataset', dest='dname', default='17flowers', type=str, help='Hack to use different train/test set')
    parser.add_argument('--output_path', default='.17flowers.noise_free', type=str, help='Path for output')
    ...
    parser.add_argument('--cfg', default='experiments/17flowers.yml', type=str, help='Config yaml file for solvers')
